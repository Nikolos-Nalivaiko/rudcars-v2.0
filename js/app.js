(() => {
    ...
    class TopMenu {
        ...
        openMenu() {
            this.isOpen = true;
            this.menuContent.classList.add("menu__content_open");
            document.body.classList.add("menu-open");
        }
        closeMenu() {
            this.isOpen = false;
            this.menuContent.classList.remove("menu__content_open");
 ...
 */
    ...
    class LazyLoader {
        ...
        createLoader(image) {
            ...
            loader.classList.add("lazy-loader");
            image.parentElement.appendChild(loader);
        }
        removeLoader(image) {
            const loader = image.parentElement.querySelector(".lazy-loader");
